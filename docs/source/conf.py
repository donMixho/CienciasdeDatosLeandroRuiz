...
# leandrocienciasdedatos documentation build
...
from leandrocienciasdedatos import __version__ as release

# -- Project information -----------------------------------------------------

project = "leandrocienciasdedatos"
author = "Kedro"
...
htmlhelp_basename = "leandrocienciasdedatosdoc"
...
latex_documents = [
    (
        master_doc,
        "leandrocienciasdedatos.tex",
        "leandrocienciasdedatos Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "leandrocienciasdedatos",
        "Project leandrocienciasdedatos codebase.",
        "Data-Science",
    )
]
